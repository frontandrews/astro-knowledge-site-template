  ...
  "font-head transition-all rounded outline-hidden cursor-pointer duration-200 font-medium flex items-center",
  {
    variants: {
      variant: {
        ...
        outline:
          "shadow-md hover:shadow active:shadow-none bg-transparent border-2 border-border text-foreground transition hover:translate-y-1 active:translate-y-2 active:translate-x-1",
        link: "bg-transparent hover:underline",
        ghost:
          "border-2 border-border bg-transparent text-foreground shadow-sm hover:bg-accent hover:translate-y-1 active:translate-x-1 active:translate-y-2",
      },
      size: {
